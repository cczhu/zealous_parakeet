...
I would like to acknowledge financial support from the University of Toronto and Ontario Ministry of Advanced Education and Skills Development via the Ontario Graduate Scholarship, and from the Natural Sciences and Engineering Research Council of Canada through the Alexander Graham Bell and Vanier Canada Graduate Scholarships.

This Ph.D. thesis would not exist without my supervisor, Marten van Kerkwijk.  I am deeply indebted to him for introducing me to the challenging and engrossing world of type Ia supernovae research, for your many years of support in both research and professional development, and for always being welcome recipient of my many (and occasionally inane) questions.  Marten, I am constantly amazed at your ability to understand and insightfully analyze topics both in and far removed from stellar astrophysics.  Thank you for being both a mentor and an inspiration over the years.
% and hope that at least a bit of that keen physical intuition has passed on to me over the years.

This thesis also would not exist without my de-facto second supervisor Philip Chang, who is always able to cut through all the technical jargon of a theoretical concept to elucidate its core physics.  Thank you for helping me understand everything from magnetic field instabilities to self-sustaining detonations, and for making time for me no matter what.  To my long-time collaborator R\"{u}diger Pakmor, thank you for helping me navigate the intricacies of the \arepo\ code; it was a privilege working with such an talented and gracious numericist.  Thanks also to James Wadsley, whose support and advice for the \gasoline\ code were invaluable.

%This thesis also would not exist without my de-facto second supervisor Philip Chang and long-time collaborator R\"{u}diger Pakmor, both of whom were always willing to lend their effort and expertise.  Thank you for clarifying the intricacies of so many concepts from magnetic field instabilities to the inaccuracies of hydro solvers, and for making time for me no matter what.

To the past and present members of the ``Van Kerkwijk White Dwarf Group'', thank you for being in our little research community.  Thanks especially to Wolfgang Kerzendorf for being my go-to programming guru and Epson Heringer for many discussions on supernova physics and observations.  I am grateful to my thesis committee members, Ue-Li Pen and Chris Matzner, for their helpful insights; special thanks to Chris Matzner for lending his expertise on hydrodynamics whenever I found a particularly confusing result.  A huge thanks also goes to the administrative staff -- especially Angie Ho and Margaret Meaney -- for ensuring meetings and examinations all ran according to plan.

To my fellow graduate students, your friendship, comaraderie and mutual support made this department a home away from home, and I will miss dearly being among you.  Thanks in particular go to my graduate cohort -- JD Emberson, Yevgeni Kissin and Etsuko Mieda -- for overcoming together the courses and qualifiers; to Robert Main, Andrey Vayner and Ari Silburt for productive science discussions and inane office shenanigans; to Mubdi Rahman, Jamil Shariff and Ilana Macdonald for not only being fast friends but mentors in science outreach; and to Stephen Ro for being there for me when I doubted my work and myself.
...
%citation{kali+07}{2007ApJ...671..748K}		% metal rich RGB stars can create He WDs?
...
%citation{mars95}{1995MNRAS.275..828M}		% low-mass white dwarfs need friends
...
%citation{nelsdm04}{2004ApJ...616.1124N}	% Lorne's work on siphoning off RGB envelopes to make He WDs (for DDs and XRBs)
...
%citation{podsrp02}{2002ApJ...565.1107P}	% L/IMXB formation, but has section (4.1) on mass distribution of He/CO WD secondaries
